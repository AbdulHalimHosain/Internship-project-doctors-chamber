...
setFilteredAppointments(appointmentsData); // Initialized filtered appointments
setLoading(false);
}, []);
...
setFilteredAppointments(filtered); // Updated filtered appointments based on search
};
